...
object Utils {
    ...
    val ATTRIBUTE_TTF_KEY = "ttf_name"

    val ATTRIBUTE_SCHEMA = "http://schemas.android.com/apk/lib/com.hitesh_sahu.retailapp.util"

    val SHOPPING_LIST_TAG = "SHoppingListFragment"
    val PRODUCT_OVERVIEW_FRAGMENT_TAG = "ProductOverView"
    val MY_CART_FRAGMENT = "MyCartFragment"
    val MY_ORDERS_FRAGMENT = "MYOrdersFragment"
    val HOME_FRAGMENT = "HomeFragment"
    val SEARCH_FRAGMENT_TAG = "SearchFragment"
    val SETTINGS_FRAGMENT_TAG = "SettingsFragment"
    val OTP_LOGIN_TAG = "OTPLogingFragment"
    val CONTACT_US_FRAGMENT = "ContactUs"
    private val PREFERENCES_FILE = "materialsample_settings"
    private val CURRENT_TAG: String? = null
    private val TYPEFACE = HashMap<String?, Typeface>()
