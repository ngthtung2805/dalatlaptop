...
class OrderCreateAddAddressFragment : Fragment() {
    ...
    fun checkRequired(): Boolean {
        val nameCheck = order_create_add_name_wrapper.checkTextInputLayoutValueRequirement( "Vui lòng nhập họ tên")
        val addressCheck = order_create_add_street_wrapper.checkTextInputLayoutValueRequirement( "Vui lòng nhập địa chỉ")
        val cityCheck = order_create_add_city_wrapper.checkTextInputLayoutValueRequirement( "Vui lòng chọn quận/huyện")
        val provinceCheck = order_create_add_province_wrapper.checkTextInputLayoutValueRequirement( "Vui lòng chọn tỉnh/thành phố")
        val emailCheck = order_create_add_email_wrapper.checkTextInputLayoutValueRequirement( "Vui lòng nhập email")
        val phoneCheck = order_create_add_phone_wrapper.checkTextInputLayoutValueRequirement( "Vui lòng nhập số điện thoại")
