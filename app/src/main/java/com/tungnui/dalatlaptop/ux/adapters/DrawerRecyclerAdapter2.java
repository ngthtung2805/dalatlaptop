...
import com.tungnui.dalatlaptop.interfaces.DrawerRecyclerInterface;
import com.tungnui.dalatlaptop.listeners.OnSingleClickListener;

/**
 * Adapter handling list of drawer items.
 */
public class DrawerRecyclerAdapter2 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
     ...
     */
    public DrawerRecyclerAdapter2(Context context, DrawerRecyclerInterface drawerRecyclerInterface) {
